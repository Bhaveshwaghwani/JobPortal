...
<%@ page import="com.pune.JobPortalApp.model.JobPost" %>
<%@ page import="com.pune.JobPortalApp.repository.JobRepository" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://pune.com/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
                ...
                <div class="card border-dark bg-dark text-white">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            ${jobPost.reqExp} years
                        </p>
                        <p class="card-text">
                            <strong>Tech Stack Required:</strong>
                            <ul>
                                <ab:forEach var="techStack" items="${jobPost.techStack}">
                                    <li>${techStack}</li>
                                </ab:forEach>
                            </ul>
                        </p>
